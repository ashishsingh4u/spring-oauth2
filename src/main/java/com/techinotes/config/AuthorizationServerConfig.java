...
public class AuthorizationServerConfig extends AuthorizationServerConfigurerAdapter {
     ...
     * These Clients are like different applications trying to use the OAuth2 authentication to validate users.
     * @param clients
     * @throws Exception
     */
    @Override
    public void configure(ClientDetailsServiceConfigurer clients) throws Exception {
        clients
                ...
                .and()
                    .withClient("my-trusted-another-client")
                    .authorizedGrantTypes("client_credentials", "password")
                    .authorities("ROLE_CLIENT","ROLE_TRUSTED_CLIENT")
                    .scopes("read","write","trust")
                    .resourceIds("oauth2-resource")
    ...
    /**
     * We here define the security constraints on the token endpoint.
